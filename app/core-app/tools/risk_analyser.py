...
with open('models/RiskPredictor_RF_V3.pkl', 'rb') as f:
    model = pickle.load(f)
...
with col1:
    ...
    uploaded_file = 'data/Test_Dataset_E100.csv'
    ...
    if uploaded_file is not None:
          ...
          if st.session_state.predictions is not None:
              ...
              entity_list=st.sidebar.multiselect("Select the entity",test_data_e['Entity'],test_data_e['Entity'][:5])
              if entity_list:
                  fig4 = go.Figure()
